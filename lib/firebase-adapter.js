      ...
      this.firebaseOn_(
        ...
        function (snapshot) {
          if (snapshot.val() === true) {
            ...
            // Add a new key to the user's connections list and remove it upon disconnecting
            const con = this.userRef_.child('connections').push();
            con.onDisconnect().remove();
            con.set(true);

            // Remove cursor selection on disconnect
